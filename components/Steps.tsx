...
const How = () => {
  return(
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-serif font-bold leading-tight text-black sm:text-4xl lg:text-5xl">How does it work?</h2>
        ...
        <div className="relative mt-12 lg:mt-20">
            ...
            <div className="relative grid grid-cols-1 text-center gap-y-12 md:grid-cols-3 gap-x-12">
                ...
                <div>
                    ...
                    <h3 className="mt-6 text-2xl font-bold leading-tight text-blue-700 md:mt-10">Book Appointment</h3>
                    <p className="mt-4 font-serif text-base text-gray-600">We deliver Clean, Foldes Clothes.</p>
                </div>
