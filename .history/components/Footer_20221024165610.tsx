...
const footerNav = {
    ...
    ContactUs:[
      ...
      {
        title: " 16/A, Toma City, New York, United States, NY, 10005 ",
        href: "/#"
      },
      {
        title: "klinixier@gmail.com",
        href: "/#"
      },
      {
        title: "Directions",
...
const Footer = () => {
    return (
    <footer className="mt-3 bg-[#1ba5dd]">
        <div className="mx-auto max-w-screen-xl px-6 pt-16 sm:px-8">
          <div className="grid grid-cols-1 gap-y-6 gap-x-6 md:!grid-cols-6 md:gap-8 xs:grid-cols-2">
            <div className="mb-4  flex flex-col xs:col-span-2">
              <span className="text-xl font-bold capitalize">Smart Laundry Cleaners</span>
              <p className="mt-4 max-w-screen-xs text-sm font-semibold">
                We are on an unwavering mission to be Kenyas most loved Cleaning Service
                platform, helping people discover any residential and commercial cleaning services at Low Prices.
              </p>
              <ul
          ...
          <div
            id="footer-copyright"
            className="mt-2 bg-blue-300 border-t border-slate-200 py-4 dark:border-slate-600"
          >
